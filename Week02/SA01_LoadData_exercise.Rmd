...
They have 6 features and are points. 

2. How many features are there inside `neighborhoods` and what is their geometry?
They have 6 features and are (multi-)polygons.

3. What is the CRS value in these objects?
The CRS value for `trees` and `neighborhoods` is  WGS 84 (World Geodetic System 1984).
...
230 rows and 253 columns.

2. What is the resolution of `manhattan`?
The resolution of `manhattan` is 29.98979 30.00062. 
