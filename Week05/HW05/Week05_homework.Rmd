...
In a first step, I analysed the slope For this, I first extracted the slope in degrees from the raster (aster) data. Then, I again used the coordinates of the mounds to get their slope values, and compared them to 733 randomly samples slopes from the raster data. Again, for both of these extracted datasets, I grouped values into bins (breaks), and calculated their frequency. Further, I plotted the distribution of elevation values beside each other to compare them. 
